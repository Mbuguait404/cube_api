...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Innovation Champion' }),
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateBadgeDto.prototype, "color", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        enum: badge_schema_1.BadgeTrigger,
        default: badge_schema_1.BadgeTrigger.MANUAL,
        description: 'When manual, admins assign it. Otherwise auto-assigned on event.',
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(badge_schema_1.BadgeTrigger),
    __metadata("design:type", String)
], CreateBadgeDto.prototype, "trigger", void 0);
