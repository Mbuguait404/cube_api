    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: daily_report_schema_1.DailyReport.name, schema: daily_report_schema_1.DailyReportSchema },
            ]),
        ],
        controllers: [daily_reports_controller_1.AdminDailyReportsController, daily_reports_controller_1.MemberDailyReportsController],
