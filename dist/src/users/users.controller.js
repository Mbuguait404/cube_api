...
let UsersController = class UsersController {
    ...
    constructor(usersService, announcementsService) {
    ...
    async getChannels(user) {
        const communityIds = await this.usersService.getMyCommunityIds(user._id.toString());
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get own profile (includes profile completion %)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get events attended (synced from CMS)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get assigned badges' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
], UsersController.prototype, "getChannels", null);
