...
@ApiTags('Health Entrepreneurship Feedback')
@Controller('health-entrepreneurship-feedback')
export class HealthEntrepreneurshipFeedbackController {
  constructor(private readonly service: HealthEntrepreneurshipFeedbackService) {}

  /** Public endpoint — no auth required */
  @Post()
  @ApiOperation({ summary: 'Submit feedback for a training day (public)' })
  create(@Body() dto: CreateHealthEntrepreneurshipFeedbackDto) {
