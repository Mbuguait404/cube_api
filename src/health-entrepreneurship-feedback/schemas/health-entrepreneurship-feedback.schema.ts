...
export type HealthEntrepreneurshipFeedbackDocument = HealthEntrepreneurshipFeedback & Document;

@Schema({ timestamps: true })
export class HealthEntrepreneurshipFeedback {
...
export const HealthEntrepreneurshipFeedbackSchema = SchemaFactory.createForClass(HealthEntrepreneurshipFeedback);
